...
public class ChestBlocks implements ModInitializer {
	...
	public static final BlockEntityType<ChestBlockBuilderEntity> CHEST_BLOCK_ENTITY = Registry.register(Registry.BLOCK_ENTITY_TYPE, id("chest_block"), BlockEntityType.Builder.create(ChestBlockBuilderEntity::new, CHEST_BLOCK, TRAPPED_CHEST_BLOCK).build(null));
